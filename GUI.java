...
public class GUI extends Application 
{
    ...
    private ListView<BattleUnitDefense> defenseAttrList = null;
    ...
    public void start(Stage primaryStage) 
    {
        ...
        openButton.setOnAction(new EventHandler<ActionEvent>() 
        {
            @Override public void handle(ActionEvent event)
            {
                ...
                defenseAttrList.setCellFactory(lv -> new ListCell<BattleUnitDefense>() 
                {
                    @Override protected void updateItem(BattleUnitDefense item, boolean empty) 
                    {
                        super.updateItem(item, empty);
                ...
                leftMenu.getChildren().addAll(new Label(givenFile.getName()), unitSelector, new Label("BattleUnitKind:"), kindList, new Label("BattleUnitDefense:"), defenseList, new Label("BattleUnitDefenseAttr:"), defenseAttrList, new Label("BattleWeapon:"), weaponList, new Label("StatusVulnerability:"), statuslist);
                ...
                unitSelector.setOnAction(e -> loadSelectedUnit(unitSelector.getSelectionModel().getSelectedIndex()));
                ...
                defenseAttrList.setOnMouseClicked(e -> 
                {
                    ...
                    BattleUnitDefense selected = defenseAttrList.getSelectionModel().getSelectedItem();
