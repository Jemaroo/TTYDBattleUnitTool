...
public class GUI extends Application 
{
    ...
    ComboBox<String> unitSelector = null;
    ...
    public void start(Stage primaryStage) 
    {
        ...
        aboutButton.setOnAction(new EventHandler<ActionEvent>() 
        {
            @Override public void handle(ActionEvent event)
            {
                ...
                Text version = new Text("Written by Jemaroo     Version: 2.1.0");
        ...
        UpdateChecker updateChecker = new UpdateChecker("Jemaroo", "TTYDBattleUnitTool", "2.1.0");
        updateChecker.check();
