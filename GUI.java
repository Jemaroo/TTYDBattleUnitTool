...
//TODO Combine Like Structs?
//TODO Add Icons for easier reading?
    ...
    public void start(Stage primaryStage) 
    {
            ...
            @Override public void handle(ActionEvent event)
            {
                ...
                fileSelector.setOnAction(e -> 
                {
                    ...
                    {                    
                        ...
                        defenseAttrList.getSelectionModel().clearSelection();
        ...
        aboutButton.setOnAction(new EventHandler<ActionEvent>() 
        {
            @Override public void handle(ActionEvent event)
            {
                ...
                Text version = new Text("Written by Jemaroo     Version: 1.2.1");
